...
import { sampleWithRequiredData } from '../conference.test-samples';
...
describe('Conference Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ConferenceComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to conferenceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getConferenceIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getConferenceIdentifier).toHaveBeenCalledWith(entity);
