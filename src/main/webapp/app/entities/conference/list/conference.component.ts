...
export class ConferenceComponent implements OnInit {
  ...
  trackId = (_index: number, item: IConference): number => this.conferenceService.getConferenceIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.conferences = this.refineData(dataFromBody);
  }

  protected refineData(data: IConference[]): IConference[] {
