...
import { sampleWithRequiredData } from '../attendee.test-samples';
...
describe('Attendee Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, AttendeeComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.attendees?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to attendeeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAttendeeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAttendeeIdentifier).toHaveBeenCalledWith(entity);
