...
import { sampleWithRequiredData } from '../speaker.test-samples';
...
describe('Speaker Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, SpeakerComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to speakerService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSpeakerIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSpeakerIdentifier).toHaveBeenCalledWith(entity);
